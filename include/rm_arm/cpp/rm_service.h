...
public:
    ...
    /// 若有错误，立即返回失败指令。
    RM_SERVICESHARED_EXPORT int Service_Movej_CANFD(SOCKHANDLE ArmSocket, const float *joint, bool follow);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_System_Runtime(SOCKHANDLE ArmSocket, char* state,int* day,
    ...
    /// \param num
    /// \param state
    /// \param mode     mode  输出参数 1-输出，0输入[-I]
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_IO_State(SOCKHANDLE ArmSocket, int IO,byte num, byte *state, byte *mode = nullptr);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_Force_Data(SOCKHANDLE ArmSocket, float *Force, float *zero_force);
    ...
    /// \return 0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Write_Single_Coil(SOCKHANDLE ArmSocket, int port,int address,int data,
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_Wired_Net(SOCKHANDLE ArmSocket, char * ip, char * mask,
                                                      char * gateway, char * mac);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Get_Wifi_Net(SOCKHANDLE ArmSocket, char * mode, char * ip,
                                                     char * mask , char * gateway, char * mac);
    ...
    /// \return                             0-成功，失败返回:错误码, rm_define.h查询.
    ///
    RM_SERVICESHARED_EXPORT int Service_Set_Voltage(SOCKHANDLE ArmSocket, byte voltage_type);
    ...
    /// \param bType                    机械臂具体型号
    ///
    RM_SERVICESHARED_EXPORT void Service_Algo_Init_Sys_Data(int dMode, RobotType bType);
