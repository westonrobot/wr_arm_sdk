...
/// 若有错误，立即返回失败指令。
RM_BASESHARED_EXPORT int Movej_CANFD(SOCKHANDLE ArmSocket, const float *joint, bool follow);
...
/// \param mode     0-通用输入模式，1-通用输出模式、2-输入开始功能复用模式，3-输入暂停功能复用模式，4-输入继续功能复用模式，5-输入急停功能复用模式[-I]
/// \return
///
RM_BASESHARED_EXPORT int Get_IO_State(SOCKHANDLE ArmSocket, int IO,byte num, byte *state, byte *mode);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_Force_Data(SOCKHANDLE ArmSocket, float *Force, float *zero_force);
...
RM_BASESHARED_EXPORT int Write_Single_Register(SOCKHANDLE ArmSocket, int port,int address,
                                               int data,int device,bool block);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Send_TrajectoryFile(SOCKHANDLE ArmSocket, const char * file_name, int file_name_len, int plan_speed,
...
///
/// \brief Set_High_Ethernet            设置高速网口网络配置[配置通讯内容]
/// \param ArmSocket                    socket句柄
/// \param ip                           网络地址
/// \param mask                         子网掩码
/// \param gateway                      网关
...
///
/// \brief Get_High_Ethernet            获取高速网口网络配置[配置通讯内容]
/// \param ArmSocket                    socket句柄
/// \param ip                           网络地址
/// \param mask                         子网掩码
/// \param gateway                      网关
...
///
/// \brief Save_Device_Info_All         保存所有参数
/// \param ArmSocket                    socket句柄
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_Wired_Net(SOCKHANDLE ArmSocket, char * ip, char * mask, char * gateway, char * mac);

///
/// \brief Get_Wifi_Net                 查询无线网卡网络信息[-I]
/// \param ArmSocket                    socket句柄
/// \param mode                         网络模式（ap代表热点模式，sta代表联网模式）
/// \param ip                           网络地址
/// \param mask                         子网掩码
/// \param gateway                      网关
/// \param mac                          MAC地址
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Get_Wifi_Net(SOCKHANDLE ArmSocket, char * mode, char * ip, char * mask , char * gateway, char * mac);
...
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Voltage(SOCKHANDLE ArmSocket, byte voltage_type);
...
/// \param bType                    机械臂具体型号
///
RM_BASESHARED_EXPORT void Algo_Init_Sys_Data(int dMode, RobotType bType);
...
/// \return 0-成功，失败返回:错误码, rm_define.h查询.
///
RM_BASESHARED_EXPORT int Set_Controller_Voltage_NC_E(SOCKHANDLE ArmSocket, byte voltage);
...
// 设置控制器端电压输出[E]
int Set_Controller_Voltage_Block_NC_E(SOCKHANDLE ArmSocket, byte voltage);
// 读取软件版本号
...
// 保存轨迹数据[E]
int Save_Drag_Teach_File_Block_NC_E(SOCKHANDLE ArmSocket, char*file_name);
// 设置机械臂仿真模式[E]
